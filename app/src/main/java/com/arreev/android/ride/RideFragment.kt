...
import com.arreev.android.databinding.RidefragmentBinding

/**
 * Created by jeffschulz on 5/15/18.
 */
class RideFragment : android.support.v4.app.Fragment()
{
    ...
    override fun onCreateView(inflater:LayoutInflater?, container:ViewGroup?, savedInstanceState:Bundle? ) : View? {
        ridefragmentview = inflater?.inflate( R.layout.ridefragment,container,false );

        val binding = android.databinding.DataBindingUtil.bind<RidefragmentBinding>( ridefragmentview  )
